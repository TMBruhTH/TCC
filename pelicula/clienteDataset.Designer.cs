...
namespace pelicula {
    ...
    public partial class clienteDataset : global::System.Data.DataSet {
        ...
        public partial class clienteDataTable : global::System.Data.TypedTableBase<clienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public clienteRow AddclienteRow(string nome, string email, string endereco, string cep, string nr, string cpf, string rg, string telefone, string cidade, string estado) {
        ...
        public partial class clienteRow : global::System.Data.DataRow {
            ...
            public string nr {
                get {
                    try {
                        return ((string)(this[this.tablecliente.nrColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'nr\' in table \'cliente\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablecliente.nrColumn] = value;
                }
            }
            ...
            public bool IsnrNull() {
                return this.IsNull(this.tablecliente.nrColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetnrNull() {
                this[this.tablecliente.nrColumn] = global::System.Convert.DBNull;
            }
...
namespace pelicula.clienteDatasetTableAdapters {
    ...
    public partial class clienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[cliente] WHERE (([idCliente] = @Original_idCliente) AND ((@IsNull_nome = 1 AND [nome] IS NULL) OR ([nome] = @Original_nome)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_endereco = 1 AND [endereco] IS NULL) OR ([endereco] = @Original_endereco)) AND ((@IsNull_cep = 1 AND [cep] IS NULL) OR ([cep] = @Original_cep)) AND ((@IsNull_nr = 1 AND [nr] IS NULL) OR ([nr] = @Original_nr)) AND ((@IsNull_cpf = 1 AND [cpf] IS NULL) OR ([cpf] = @Original_cpf)) AND ((@IsNull_rg = 1 AND [rg] IS NULL) OR ([rg] = @Original_rg)) AND ((@IsNull_telefone = 1 AND [telefone] IS NULL) OR ([telefone] = @Original_telefone)) AND ((@IsNull_cidade = 1 AND [cidade] IS NULL) OR ([cidade] = @Original_cidade)) AND ((@IsNull_estado = 1 AND [estado] IS NULL) OR ([estado] = @Original_estado)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[cliente] ([nome], [email], [endereco], [cep], [nr], [cpf], [rg], [telefone], [cidade], [estado]) VALUES (@nome, @email, @endereco, @cep, @nr, @cpf, @rg, @telefone, @cidade, @estado);
SELECT idCliente, nome, email, endereco, cep, nr, cpf, rg, telefone, cidade, estado FROM cliente WHERE (idCliente = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[cliente] SET [nome] = @nome, [email] = @email, [endereco] = @endereco, [cep] = @cep, [nr] = @nr, [cpf] = @cpf, [rg] = @rg, [telefone] = @telefone, [cidade] = @cidade, [estado] = @estado WHERE (([idCliente] = @Original_idCliente) AND ((@IsNull_nome = 1 AND [nome] IS NULL) OR ([nome] = @Original_nome)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_endereco = 1 AND [endereco] IS NULL) OR ([endereco] = @Original_endereco)) AND ((@IsNull_cep = 1 AND [cep] IS NULL) OR ([cep] = @Original_cep)) AND ((@IsNull_nr = 1 AND [nr] IS NULL) OR ([nr] = @Original_nr)) AND ((@IsNull_cpf = 1 AND [cpf] IS NULL) OR ([cpf] = @Original_cpf)) AND ((@IsNull_rg = 1 AND [rg] IS NULL) OR ([rg] = @Original_rg)) AND ((@IsNull_telefone = 1 AND [telefone] IS NULL) OR ([telefone] = @Original_telefone)) AND ((@IsNull_cidade = 1 AND [cidade] IS NULL) OR ([cidade] = @Original_cidade)) AND ((@IsNull_estado = 1 AND [estado] IS NULL) OR ([estado] = @Original_estado)));
SELECT idCliente, nome, email, endereco, cep, nr, cpf, rg, telefone, cidade, estado FROM cliente WHERE (idCliente = @idCliente)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT idCliente, nome, email, endereco, cep, nr, cpf, rg, telefone, cidade, esta" +
                "do FROM dbo.cliente";
        ...
        public virtual int Delete(int Original_idCliente, string Original_nome, string Original_email, string Original_endereco, string Original_cep, string Original_nr, string Original_cpf, string Original_rg, string Original_telefone, string Original_cidade, string Original_estado) {
        ...
        public virtual int Insert(string nome, string email, string endereco, string cep, string nr, string cpf, string rg, string telefone, string cidade, string estado) {
            if ((nome == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_cidade, 
                    string Original_estado) {
            return this.Update(nome, email, endereco, cep, nr, cpf, rg, telefone, cidade, estado, Original_idCliente, Original_nome, Original_email, Original_endereco, Original_cep, Original_nr, Original_cpf, Original_rg, Original_telefone, Original_cidade, Original_estado, Original_idCliente);
        }
    }
